# ====================================================================================
# Setup Project
PROJECT_NAME := provider-exoscale2
...
XPKGS = provider-exoscale2
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-exoscale2: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Exoscale2 CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Exoscale2 controllers
...
# This target prepares repo for your provider by replacing all "exoscale2"
